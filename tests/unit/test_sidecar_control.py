"""Tests for GUI-ready sidecar control contracts."""
...
def test_job_snapshot_round_trips_with_progress_and_controls() -> None:
    ...
    snapshot = SidecarJobSnapshot.from_handle(_Handle()).with_progress(progress)
    payload = snapshot.to_dict()
    round_trip = SidecarJobSnapshot.from_dict(payload)
...
def test_job_snapshot_represents_cancel_retry_resume_transitions() -> None:
    ...
    base = SidecarJobSnapshot.from_handle(
        _Handle(),
