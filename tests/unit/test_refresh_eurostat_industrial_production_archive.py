"""Tests for the Eurostat industrial-production refresh boundary."""
...
from scripts import refresh_eurostat_industrial_production_archive as refresh
...
def _document_request(
    ...
    return OfficialSourceRequestV1(
        ...
        uri=(
            ...
            f"4-21012002-AP-EN.{suffix}/source"
        ),
...
def test_refresh_retains_release_documents_separately(
    ...
    assert refresh._local_path(tmp_path, request) == (
        tmp_path / "documents" / f"4-21012002-ap.{suffix}"
    )
