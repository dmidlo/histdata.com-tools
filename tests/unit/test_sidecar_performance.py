"""Tests for sidecar performance policy and benchmark helpers."""
...
def test_sidecar_concurrency_profile_preserves_legacy_multipliers(
    monkeypatch,
) -> None:
    ...
    profile = build_sidecar_concurrency_profile(cpu_utilization="medium")
...
def test_sidecar_concurrency_profile_allows_lane_overrides(
    monkeypatch,
) -> None:
    ...
    profile = build_sidecar_concurrency_profile(
