"""Tests for sidecar runtime retention and maintenance."""
...
def test_sidecar_maintenance_rotates_logs_and_prunes_status_store(
    tmp_path: Path,
) -> None:
    """Maintenance should bound sidecar state without deleting data artifacts."""
...
def test_sidecar_maintenance_skips_mutation_while_running(
    tmp_path: Path,
) -> None:
