"""Tests for the Eurostat construction-output refresh boundary."""
...
from scripts import refresh_eurostat_construction_output_archive as refresh
...
def _product_request() -> OfficialSourceRequestV1:
    ...
    return OfficialSourceRequestV1(
        ...
        uri="https://ec.europa.eu/eurostat/product?code=4-16092026-ap",
...
def _document_request(
    ...
    return OfficialSourceRequestV1(
        ...
        method=OfficialRequestMethod.GET,
        uri=(
            "https://ec.europa.eu/eurostat/documents/2995521/5213294/"
            f"4-13032002-AP-EN.{suffix}/source"
        ),
...
def test_refresh_prefers_equivalent_canonical_landing_uri() -> None:
    content = b"""<html><head>
    <link rel="canonical" href="https://ec.europa.eu/eurostat/web/products-euro-indicators/w/4-16092026-ap">
    <meta property="og:url" content="https://ec.europa.eu/eurostat/en/web/products-euro-indicators/w/4-16092026-ap">
    </head></html>"""

    assert refresh._resolved_uri(_product_request(), content) == (
        "https://ec.europa.eu/eurostat/web/products-euro-indicators/w/4-16092026-ap"
    )
...
def test_refresh_rejects_conflicting_landing_uri_metadata() -> None:
    content = b"""<html><head>
    <link rel="canonical" href="https://ec.europa.eu/eurostat/web/products-euro-indicators/w/4-16092026-ap">
    <meta property="og:url" content="https://ec.europa.eu/eurostat/en/web/products-euro-indicators/w/4-13082026-ap">
    </head></html>"""
...
def test_refresh_retains_release_documents_separately(
    ...
    assert refresh._local_path(tmp_path, request) == (
        tmp_path / "documents" / f"4-13032002-ap.{suffix}"
    )
