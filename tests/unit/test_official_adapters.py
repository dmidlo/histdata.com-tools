...
def test_built_in_parsers_cover_every_registered_source_and_format(
    ...
    assert isinstance(
        parsers["official.insee-industrial-production.v1"],
        OfficialInseeIndustrialProductionParserV1,
    )
    assert isinstance(
    ...
    assert isinstance(
        parsers["official.insee-ilo-unemployment.v1"],
        OfficialInseeIloUnemploymentParserV1,
    )
    assert isinstance(
    ...
    assert isinstance(
        parsers["official.eurostat-labour-cost.v1"],
        OfficialEurostatLabourCostParserV1,
    )
    assert isinstance(
