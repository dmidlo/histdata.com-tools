...
class OfficialInseeCpiParserV1(OfficialHtmlParserV1):
    ...
    parser_id = "official.insee-cpi.v1"
    supported_formats: tuple[OfficialSourceFormat, ...] = (
        OfficialSourceFormat.JSON,
        OfficialSourceFormat.HTML,
...
class OfficialInseeIloUnemploymentParserV1(OfficialHtmlParserV1):
    """Bind INSEE unemployment Solr, release HTML, and BDM artifacts."""

    parser_id = "official.insee-ilo-unemployment.v1"
    supported_formats: tuple[OfficialSourceFormat, ...] = (
        OfficialSourceFormat.JSON,
        OfficialSourceFormat.HTML,
        OfficialSourceFormat.SDMX_21,
...
class OfficialInseeBusinessClimateParserV1(OfficialHtmlParserV1):
    """Bind INSEE business-climate Solr, HTML, and BDM artifacts."""

    parser_id = "official.insee-business-climate.v1"
    supported_formats: tuple[OfficialSourceFormat, ...] = (
        OfficialSourceFormat.JSON,
        OfficialSourceFormat.HTML,
        OfficialSourceFormat.SDMX_21,
...
class OfficialInseeIndustrialProductionParserV1(OfficialHtmlParserV1):
    """Bind INSEE industrial-production Solr, HTML, and BDM artifacts."""

    parser_id = "official.insee-industrial-production.v1"
    supported_formats: tuple[OfficialSourceFormat, ...] = (
        OfficialSourceFormat.JSON,
        OfficialSourceFormat.HTML,
        OfficialSourceFormat.SDMX_21,
...
class OfficialInseeConsumerConfidenceParserV1(OfficialHtmlParserV1):
    """Bind INSEE confidence Solr, release HTML, and BDM artifacts."""

    parser_id = "official.insee-consumer-confidence.v1"
    supported_formats: tuple[OfficialSourceFormat, ...] = (
        OfficialSourceFormat.JSON,
        OfficialSourceFormat.HTML,
        OfficialSourceFormat.SDMX_21,
...
class OfficialEurostatGdpParserV1(OfficialHtmlParserV1):
    """Bind GDP Atom inventory, JSON-stat table, HTML, and PDFs."""

    parser_id = "official.eurostat-gdp.v1"
    supported_formats: tuple[OfficialSourceFormat, ...] = (
...
class OfficialEurostatIndustrialProductionParserV1(OfficialHtmlParserV1):
    """Bind industrial-production Atom, JSON-stat, HTML, and PDF artifacts."""

    parser_id = "official.eurostat-industrial-production.v1"
    supported_formats: tuple[OfficialSourceFormat, ...] = (
        OfficialSourceFormat.ATOM,
        OfficialSourceFormat.JSON_STAT,
        OfficialSourceFormat.HTML,
...
class OfficialEurostatConstructionOutputParserV1(OfficialHtmlParserV1):
    """Bind construction-output Atom, JSON-stat, HTML, and PDF artifacts."""

    parser_id = "official.eurostat-construction-output.v1"
    supported_formats: tuple[OfficialSourceFormat, ...] = (
        OfficialSourceFormat.ATOM,
        OfficialSourceFormat.JSON_STAT,
        OfficialSourceFormat.HTML,
...
class OfficialEurostatRetailTradeParserV1(OfficialHtmlParserV1):
    """Bind retail-trade Atom, JSON-stat, HTML, and PDF artifacts."""

    parser_id = "official.eurostat-retail-trade.v1"
    supported_formats: tuple[OfficialSourceFormat, ...] = (
        OfficialSourceFormat.ATOM,
        OfficialSourceFormat.JSON_STAT,
        OfficialSourceFormat.HTML,
...
class OfficialEurostatLabourCostParserV1(OfficialHtmlParserV1):
    """Bind labour-cost Atom, JSON-stat, HTML, and PDF artifacts."""

    parser_id = "official.eurostat-labour-cost.v1"
    supported_formats: tuple[OfficialSourceFormat, ...] = (
        OfficialSourceFormat.ATOM,
        OfficialSourceFormat.JSON_STAT,
        OfficialSourceFormat.HTML,
...
class OfficialEurostatUnemploymentParserV1(OfficialHtmlParserV1):
    ...
    parser_id = "official.eurostat-unemployment.v1"
    supported_formats: tuple[OfficialSourceFormat, ...] = (
        OfficialSourceFormat.ATOM,
        OfficialSourceFormat.JSON_STAT,
        OfficialSourceFormat.HTML,
...
_BUILT_IN_PARSER_TYPES: tuple[type[_BaseOfficialParser], ...] = (
    ...
    OfficialInseeIndustrialProductionParserV1,
    ...
    OfficialEurostatLabourCostParserV1,
