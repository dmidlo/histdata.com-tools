...
def built_in_united_states_backfill_profile(
    ...
    programs = (
        ...
        _program(
            ...
            limitations=(
                "Use the complete occurrence-specific JOLTS archive manifest for total-nonfarm job openings, hires, and total separations.",
                "The monthly seasonally adjusted triplet archive begins in March 2004; February 2004 is retained as predecessor evidence.",
                "September 2025 was not published; October retains August as the previous published occurrence.",
                "Annual benchmark revisions remain occurrence-specific and never rewrite earlier JOLTS vintages.",
                *no_monthly_consensus,
            ),
        ),
        _program(
            ...
            archive_start_date="2002-10-17",
            frequency="weekly",
            limitations=(
                "Use the occurrence-specific ETA archive for regular-state seasonally adjusted initial claims; continued, unadjusted, federal, and pandemic-program claims require separate identities.",
                "The official occurrence archive begins October 17, 2002; the first retained release is predecessor-only and pre-boundary releases are unavailable from that archive.",
                "The October 17, 2019 release is absent from ETA's index, two 2013 artifacts are duplicated under 2012, and one 2014 link is an authored dummy PDF.",
                "Seven publications from October 2 through November 13, 2025 were not issued during the appropriations lapse; the November 20 restart is retained but its revision is noncomparable.",
                *no_monthly_consensus,
            ),
        ),
        _program(
        ...
        _program(
            ...
            census_schedule,
            limitations=(
                "Use the complete occurrence-specific MARTS archive for total, ex-autos, ex-gasoline, and retail-control monthly changes.",
                "The May 2001 SIC-to-NAICS boundary is retained but not treated as a comparable revision.",
                "Image-only PDFs use reviewed hash-bound OCR; January 2013 onward uses exact official XLS/XLSX tables when available.",
                "The official annual-revision archive supplies 24 intervening prior-month states for 2002-2025; the non-overlapping 2000-2001 reports remain retained evidence.",
                ...
                "Shutdown delays preserve their actual publication dates without creating synthetic missing reference periods.",
                *no_monthly_consensus,
            ),
        ),
        _program(
        ...
        _program(
            ...
            census_schedule,
            limitations=(
                "Use the complete occurrence-specific M3 advance archive for total durable-goods new orders and nondefense capital-goods new orders excluding aircraft.",
                "The official November 2009 notice is retained as measure unavailable; no replacement value is manufactured.",
                "The source omits the core row from April 2001 through April 2002, while headline occurrence coverage remains complete.",
                "Thirty-seven scan-only PDFs use reviewed hash-bound OCR, and the broken July 2005 index link uses only the verified official legacy URI.",
                "Three 10:00 releases, ten source-authored DST errors, annual historical revisions, and both shutdown-delay sequences remain occurrence-specific.",
                *no_monthly_consensus,
            ),
        ),
        _program(
            ...
            census_schedule,
            limitations=(
                "Use the complete occurrence-specific FT-900 archive for the headline seasonally adjusted goods-and-services deficit.",
                "The retired archive route, six wrong-target PDF links, and the source's Ferbruary 2019 label remain explicit bounded evidence.",
                "Sixty-one legacy reports without zone tokens use the producer-local New York convention; five later source-authored DST abbreviation errors remain auditable.",
                "Concurrent annual revisions retain both the preceding initial vintage and the revised value instead of rewriting history.",
                "Federal funding lapses preserve their actual publication sequence and never create synthetic release times.",
                *no_monthly_consensus,
            ),
        ),
        _program(
            ...
            census_schedule,
            limitations=(
                "Use the complete occurrence-specific New Residential Construction archive for total building permits, housing starts, and housing completions.",
                "January 2000 through March 2001 retains separate starts/permits and completions publication times before the unified PDF era.",
                "Three broken archive links are corrected only to verified official predictable URIs, while the September/October 2013 duplicate publication remains one event.",
                "Government-disruption catch-up reports retain every missed-month initial value without manufacturing a separate publication time.",
                "Fourteen same-publication prior-month comparisons remain non-comparable rather than being mislabeled as ex-ante previous-as-known values.",
                *no_monthly_consensus,
            ),
        ),
        _program(
            ...
            "New Residential Sales",
            "U.S. Census Bureau and U.S. Department of Housing and Urban Development",
            "us.census.new-residential-sales",
            "https://www.census.gov/construction/nrs/data/releases.html",
            census_schedule,
            scheduled_time_local="10:00",
            limitations=(
                "Use the complete occurrence-specific New Residential Sales archive for total new single-family houses sold at a seasonally adjusted annual rate.",
                "The retired historical-data route is preserved as an explicit migration and the broken December 2018 index link is corrected only to the surviving Census URI.",
                "September and October 2013 retain one real December 4 publication time, while later government-disruption catch-up reports do not manufacture separate events.",
                "Same-publication prior-month comparisons remain non-comparable rather than being mislabeled as ex-ante previous-as-known values.",
                "The February 2001 source-authored January 2000 label typo is retained without changing the sequential January 2001 lineage.",
                *no_monthly_consensus,
            ),
        ),
        _program(
        ...
        _program(
            ...
            "U.S. Census Bureau",
            "us.census.mtis",
            "https://www.census.gov/mtis/historic_releases.html",
            census_schedule,
            scheduled_time_local="10:00",
            limitations=(
                "Inventories, sales, and inventory-sales ratios remain separate concepts.",
                "Historical source-authored release times vary between 08:30 and 10:00 Eastern; the program time is the current nominal schedule.",
                *no_monthly_consensus,
            ),
        ),
    )
