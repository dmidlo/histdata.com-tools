...
def built_in_united_states_backfill_profile(
    ...
    programs = (
        ...
        _program(
            ...
            bls_schedule,
            limitations=(
                "Use occurrence-specific CPI releases for initial and previous values.",
                *no_monthly_consensus,
            ),
        ),
        _program(
            ...
            bls_schedule,
            limitations=(
                "Final-demand PPI begins in 2014; retain the finished-goods lineage before that change.",
                *no_monthly_consensus,
            ),
        ),
        _program(
            ...
            bls_schedule,
            limitations=(
                "Household and establishment surveys remain distinct within the release package.",
