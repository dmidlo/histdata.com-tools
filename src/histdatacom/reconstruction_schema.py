...
_AUDITED_MODULES = (
    ...
    "histdatacom.reconstruction_math",
    ...
    "histdatacom.synthetic.release_holdout_evaluation",
...
_REQUIRED_SCHEMA_TOKENS = (
    ...
    "hawkes-residual-policy",
    "hawkes-residual-window",
    "hawkes-mark-calibration-bin",
    "hawkes-residual-stratum",
    "hawkes-residual-power-result",
    "hawkes-residual-report",
    ...
    "release-holdout-evaluation-policy",
    "reconstruction-release-holdout-authorization",
    "release-holdout-gate-report",
    "reconstruction-release-holdout-receipt",
    "reconstruction-release-holdout-retirement",
