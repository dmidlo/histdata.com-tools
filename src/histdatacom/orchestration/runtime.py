...
class OrchestrationPaths:
    ...
    @classmethod
    def from_runtime_dir(cls, runtime_dir: Path | str) -> "OrchestrationPaths":
    ...
    @classmethod
    def from_state_dir(cls, state_dir: Path | str) -> "OrchestrationPaths":
...
class OrchestrationPorts:
    """Network ports used by the local Temporal orchestration."""
...
@dataclass(frozen=True, slots=True)
class OrchestrationRuntimePolicy:
    """Resolved local runtime policy for one workspace orchestration."""
...
def default_orchestration_runtime_home(
    *,
...
def default_orchestration_workspace(
    *,
    environ: Mapping[str, str] | None = None,
) -> Path:
...
def default_orchestration_state_dir() -> Path:
    """Return the default workspace-scoped runtime state directory."""
    return build_orchestration_runtime_policy().paths.state_dir


def build_orchestration_runtime_policy(
    *,
    ...
    resolved_home = (
        ...
        else default_orchestration_runtime_home(
            environ=env,
    ...
    resolved_paths = paths or OrchestrationPaths.from_runtime_dir(runtime_dir)
    if check_ports:
    ...
    return OrchestrationRuntimePolicy(
...
def _resolve_workspace_path(
    ...
    return default_orchestration_workspace(environ=environ)
...
def _allocate_ports(
    *,
    ...
    environ: Mapping[str, str],
    port_available: PortAvailabilityProbe,
    existing: OrchestrationPorts | None = None,
) -> OrchestrationPorts:
...
RuntimePaths = OrchestrationPaths
RuntimePorts = OrchestrationPorts
RuntimePolicy = OrchestrationRuntimePolicy
build_runtime_policy = build_orchestration_runtime_policy
default_runtime_home = default_orchestration_runtime_home
default_state_dir = default_orchestration_state_dir
default_workspace = default_orchestration_workspace
