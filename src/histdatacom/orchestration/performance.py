"""Performance policy and lightweight benchmark helpers for the orchestration."""
...
class OrchestrationConcurrencyProfile:
...
def build_orchestration_concurrency_profile(
    *,
    ...
    """Build orchestration worker concurrency from configured CPU policy."""
    base_workers = get_pool_cpu_count(cpu_utilization)
    multiplier = _positive_int(
        network_multiplier,
        field_name="network_multiplier",
    )
    profile = OrchestrationConcurrencyProfile(
