"""Temporal activity functions for orchestration operation migration."""
...
def default_activities() -> tuple[Callable[..., Any], ...]:
    """Return default orchestration activities for worker registration."""
    return (
...
def _dataset_plan_batches(
    ...
    from histdatacom.orchestration.workflows import period_batch_partitions
