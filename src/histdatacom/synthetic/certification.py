    ...
    *,
    ...
    requirements = (
        ...
        _requirement(
            ...
            "The exact estimand, assumptions, context semantics, and validity labels verify.",
        ),
        _requirement(
            CertificationGate.INFORMATION_SAFETY,
        ...
        _requirement(
            ...
            "Experiment, plan-derived product, and published dataset bind one ledger identity.",
        ),
        _requirement(
            CertificationGate.INFORMATION_SAFETY,
            ...
            CertificationComparator.ZERO,
            0,
            ("reconstruction-scientific-ledger", "information-audit-report"),
            "Every conditioning input records completeness, missingness, and information mode.",
        ),
        _requirement(
            CertificationGate.INFORMATION_SAFETY,
            ...
            0,
            ("reconstruction-product-manifest",),
            "No generated row is serialized as observed, recovered truth, or broker history.",
        ),
        _requirement(
            CertificationGate.INFORMATION_SAFETY,
        ...
        _requirement(
            ...
            "Every selected engine and frozen portfolio weight comes from powered qualification, the validation-only product-selection dossier, and holdout-calibrated observation and feed-transition uncertainty reports.",
        ),
        _requirement(
            CertificationGate.CONDITIONED_SCORECARDS,
            "conditioned_tolerance_violation_count",
